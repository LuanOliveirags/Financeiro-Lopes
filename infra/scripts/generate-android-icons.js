...
const MASKABLE_SRC = path.join(root, 'apps/web/public/assets/images/icon-maskable-512.png');
const LOGO_SRC     = path.join(root, 'apps/web/public/assets/images/icon-512.png');
const MIPMAP_DIR   = path.join(root, 'apps/mobile/android/app/src/main/res');
